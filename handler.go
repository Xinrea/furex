...
type TouchHandler interface {
	...
	HandleJustReleasedTouchID(touch ebiten.TouchID, x, y int, isCancel bool)
}
...
type ViewHandler struct {
	...
	JustReleasedTouchID         func(touch ebiten.TouchID, x, y int, isCancel bool)
...
func (h *ViewHandler) HandleJustReleasedTouchID(touch ebiten.TouchID, x int, y int, isCancel bool) {
	if h.JustReleasedTouchID != nil {
		h.JustReleasedTouchID(touch, x, y, isCancel)
	}
}
